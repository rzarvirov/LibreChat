...
export const promptExamples: PromptExample[] = [
  {
    en: "Can you look at this photo of my monstera plant and tell me why the leaves are turning yellow at the edges?",
    ru: "Посмотри на это фото моего растения монстера и скажи, почему листья желтеют по краям?"
  },
  {
    en: "I've attached a research paper on T-cell responses - could you summarize the key findings?",
    ru: "Я прикрепил научную статью о реакциях Т-клеток - не мог бы ты обобщить основные выводы?"
  },
  {
  ...
  },
  {
    ...
    ru: "Вот фото домашней работы по алгебре моего восьмиклассника - можешь указать на ошибки?"
  },
  {
    en: "Suggest three keto-friendly dinner recipes using chicken, avocado, and cauliflower",
    ru: "Предложи три кето-рецепта для ужина с курицей, авокадо и цветной капустой"
  },
  {
    en: "Review my software engineer resume [PDF attached], particularly my AWS and Python experience",
    ru: "Просмотри мое резюме инженера-программиста [PDF прикреплен], особенно части про опыт с AWS и Python"
  },
  {
    en: "I'm attaching my rental agreement - could you explain the early termination clause in simple terms?",
    ru: "Я прикрепляю договор аренды - можешь объяснить простыми словами пункт о досрочном расторжении?"
  },
  {
    en: "Design a 30-minute HIIT workout using only resistance bands and a yoga mat",
    ru: "Составь 30-минутную HIIT тренировку, используя только резинки и коврик для йоги"
  },
  {
    en: "Take a look at this rash on my 3-year-old's arm [Photo attached] - is it chickenpox or an allergy?",
    ru: "Посмотри на эту сыпь на руке моего 3-летнего ребенка [Фото прикреплено] - это ветрянка или аллергия?"
  },
  {
    en: "Write a product description for my handmade leather wallet with card slots",
    ru: "Напиши описание товара для моего кожаного кошелька ручной работы с отделениями для карт"
  },
  {
    en: "My 6-year-old drew this superhero - can you create a story based on their drawing?",
    ru: "Мой 6-летний ребенок нарисовал этого супергероя - можешь придумать историю по рисунку?"
  },
  {
    en: "Is $2800 reasonable for replacing a Prius hybrid battery and labor?",
    ru: "Разумна ли цена в $2800 за замену гибридной батареи Prius с работой?"
  },
  {
    en: "Plan a 2-week Italy trip for $3000, focusing on historic sites and local food",
    ru: "Спланируй двухнедельное путешествие по Италии за $3000 с акцентом на исторические места и местную кухню"
  },
  {
    en: "Could you review the IP rights section in this freelance contract I'm sharing?",
    ru: "Можешь просмотреть раздел о правах на интеллектуальную собственность в контракте фрилансера, который я отправляю?"
  },
  {
    en: "Suggest modern Scandinavian decor ideas for my 400 sq ft studio apartment",
    ru: "Предложи идеи современного скандинавского декора для моей студии площадью 37 кв. м"
  },
  {
    en: "Create a Spanish learning plan focusing on medical terminology for nurses",
    ru: "Составь план изучения испанского с акцентом на медицинскую терминологию для медсестер"
  },
  {
  ...
  },
  {
    ...
    ru: "Судя по этим результатам анализов [Отчет прикреплен], на что указывают повышенные ферменты печени?"
  },
  {
    en: "Make a study schedule for CFA Level 1 exam with 4 hours daily",
  ...
  },
  {
    ...
    ru: "Можешь изучить эти рентгеновские снимки грудной клетки и объяснить, что ты наблюдаешь? [Медицинские снимки прикреплены]"
  },
  {
