...
export default {
  ...
  com_ui_terms_title: 'Условия использования AiBuddy',
  com_ui_terms_content: `# Условия использования LibreChat

*Дата вступления в силу: 18 февраля 2024 г.*

Добро пожаловать в LibreChat, информационный веб-сайт платформы чата с открытым исходным кодом на базе ИИ, доступный по адресу https://librechat.ai. Настоящие Условия использования ("Условия") регулируют использование вами нашего веб-сайта и предлагаемых нами услуг. Получая доступ к Веб-сайту или используя его, вы соглашаетесь соблюдать настоящие Условия и нашу Политику конфиденциальности, доступную по адресу https://librechat.ai//privacy.

## 1. Право собственности

При покупке пакета у LibreChat вам предоставляется право загружать и использовать код для доступа к панели администратора LibreChat. Хотя вы владеете загруженным кодом, вам категорически запрещается перепродавать, распространять или иным образом передавать код третьим лицам без явного разрешения LibreChat.

## 2. Пользовательские данные

Мы собираем личные данные, такие как ваше имя, адрес электронной почты и платежную информацию, как описано в нашей Политике конфиденциальности. Эта информация собирается для предоставления и улучшения наших услуг, обработки транзакций и общения с вами.

## 3. Сбор неперсональных данных

Веб-сайт использует файлы cookie для улучшения пользовательского опыта, анализа использования сайта и обеспечения определенных функций. Используя Веб-сайт, вы соглашаетесь на использование файлов cookie в соответствии с нашей Политикой конфиденциальности.

## 4. Использование Веб-сайта

Вы соглашаетесь использовать Веб-сайт только в законных целях и таким образом, который не нарушает права других лиц, не ограничивает и не препятствует использованию и получению удовольствия от Веб-сайта другими лицами. Запрещенное поведение включает преследование или причинение беспокойства или неудобств любому лицу, передачу непристойного или оскорбительного контента или нарушение нормального потока диалога на Веб-сайте.

## 5. Применимое право

Настоящие Условия регулируются и толкуются в соответствии с законодательством Соединенных Штатов, без учета каких-либо принципов коллизионного права.

## 6. Изменения в Условиях

Мы оставляем за собой право изменять настоящие Условия в любое время. Мы уведомим пользователей о любых изменениях по электронной почте. Продолжение использования вами Веб-сайта после уведомления о таких изменениях будет означать ваше согласие с такими изменениями.

## 7. Контактная информация

Если у вас есть какие-либо вопросы об этих Условиях, пожалуйста, свяжитесь с нами по адресу contact@librechat.ai.

Используя Веб-сайт, вы подтверждаете, что прочитали настоящие Условия использования и соглашаетесь соблюдать их.`,
  com_auth_error_login:
    'Не удалось войти с предоставленной информацией. Пожалуйста, проверьте ваши учетные данные, попробуйте снова или запросите сброс пароля.',
  ...
  com_subscription_button: 'Посмотреть тарифные планы',
  com_subscription_title: 'Выберите свой план',
  com_subscription_subtitle: 'Выберите идеальный план для ваших потребностей',
  com_subscription_basic: 'Базовый',
  com_subscription_pro: 'Про',
  com_subscription_proplus: 'Про+',
  com_subscription_subscribe: 'Подписаться',
  com_subscription_basic_price: '~199 ₽/мес',
  com_subscription_pro_price: '~499 ₽/мес',
  com_subscription_proplus_price: '~999 ₽/мес',
  com_subscription_basic_feature_1: 'Доступ к базовым ИИ-ассистентам',
  com_subscription_basic_feature_2: 'До ~100 сообщений в день',
  com_subscription_basic_feature_3: 'ChatGPT, Claude, Google и другие',
  com_subscription_pro_feature_1: 'Доступ к профессиональным ИИ-ассистентам',
  com_subscription_pro_feature_2: 'До ~500 сообщений в день',
  com_subscription_pro_feature_3: 'Создание пользовательских агентов',
  com_subscription_pro_feature_4: 'ChatGPT o1, Claude Sonnet, DeepSeek R1 и другие',
  com_subscription_proplus_feature_1: 'Все функции Pro-версии',
  com_subscription_proplus_feature_2: 'Без ограничений на сообщения',
  com_subscription_proplus_feature_3: 'Премиум поддержка',
  com_subscription_proplus_feature_4: 'Ранний доступ к новым функциям',
  com_subscription_proplus_feature_5: 'Максимальная скорость и производительность',
  com_error_insufficient_funds: 'Недостаточно средств! Баланс: {{0}} токенов',
  com_subscription_view_plans: 'Посмотреть тарифные планы',
  com_subscription_manage: 'Управление подпиской',
  com_subscription_cancel: 'Отменить подписку',
  com_subscription_current_plan: 'Текущий план',
  com_subscription_balance: 'Баланс',
  com_subscription_next_payment: 'Следующий платеж',
  com_subscription_cancel_confirm: 'Вы уверены, что хотите отменить подписку?',
  com_subscription_cancel_success: 'Ваша подписка будет отменена в конце расчетного периода',
  com_subscription_no_active: 'Активная подписка не найдена',
  ...
  com_subscription_reactivated: 'Ваша подписка успешно возобновлена',
  com_subscription_login_required: 'Пожалуйста, войдите в систему для управления подпиской',
  com_subscription_login_change: 'Пожалуйста, войдите в систему для изменения подписки',
  com_subscription_error_cancel: 'Не удалось отменить подписку',
  com_subscription_error_reactivate: 'Не удалось возобновить подписку',
  com_subscription_error_change: 'Не удалось изменить подписку',
  com_token_what_are_tokens: 'Что такое Токены ИИ?',
  com_token_explanation_brain: 'Токены - это единицы обработки текста. Один токен может быть обычным словом, частью слова или даже одной буквой. Продвинутый ИИ разбивает текст на меньшие кусочки для лучшего понимания.',
  com_token_explanation_chat: 'И ваш вопрос, и ответ ИИ используют токены. Простая формула: Длинные разговоры + Умный ИИ = Больше токенов.',
  com_token_explanation_image: 'Изображения требуют значительно больше, чем текст, потому что содержат больше точек данных для обработки.',
  com_subscription_cancel_notice: 'Вы можете отменить подписку в любое время в настройках аккаунта',
  com_error_ban: 'Ваша учетная запись была временно заблокирована в связи с нарушениями нашего сервиса.',
  com_error_invalid_api_key: 'Неверный API-ключ. Пожалуйста, проверьте ваш API-ключ и попробуйте снова. Вы можете сделать это, нажав на логотип модели в левом углу текстового поля и выбрав "Установить токен" для текущего выбранного эндпоинта. Спасибо за понимание.',
  com_error_insufficient_quota: 'Приносим извинения за неудобства. API-ключ по умолчанию достиг своего лимита. Чтобы продолжить использование сервиса, пожалуйста, установите свой собственный API-ключ. Вы можете сделать это, нажав на логотип модели в левом углу текстового поля и выбрав "Установить токен" для текущего выбранного эндпоинта. Спасибо за понимание.',
  com_error_concurrent: 'Только {0} сообщени{1} одновременно. Пожалуйста, дождитесь завершения других ответов перед отправкой нового сообщения или подождите одну минуту.',
  com_error_message_limit: 'Вы достигли лимита сообщений. У вас установлен лимит в {0} сообщени{1} за {2}.',
  com_error_token_balance: 'Недостаточно средств! Баланс: {0}',
  com_error_default: 'Что-то пошло не так. Ваш запрос не поддерживается выбранной моделью',
  com_model_features_speed: 'Скорость',
  ...
  com_model_features_intelligence_high: 'Высокий',
  com_model_features_intelligence_very_high: 'Очень высокий',
  com_model_features_context_window: 'Размер контекста',
  com_model_features_context_window_suffix: 'токенов',
  com_ui_typewriter_help_me: 'Помоги мне 🌞 ',
  com_ui_typewriter_write_text: 'писать тексты',
  com_ui_typewriter_analyze_images: 'анализировать изображения',
  com_ui_typewriter_solve_problems: 'планировать путешествия',
  com_ui_typewriter_make_decisions: 'принимать решения',
  com_ui_typewriter_create_better_world: 'создавать вещи, которые делают мир лучше',
  com_subscription_or: 'или',
  com_subscription_via: 'Подписаться через',
  com_subscription_boosty: 'Boosty',
  com_subscription_boosty_manage: 'Подписаны на нас в Boosty? Нажмите здесь, чтобы управлять',
  com_error_token_balance_note: 'Примечание: Ваш баланс автоматически пополняется каждые 12 часов до 1000 токенов для бесплатного использования. Рассмотрите возможность подписки для непрерывного доступа ко всем функциям.',
  com_nav_enter_to_send_mobile: 'Enter для отправки (мобильный)',
  com_nav_info_enter_to_send_mobile: 'Используйте клавишу Enter для отправки сообщения на мобильных устройствах, по умолчанию отключено для лучшего мобильного опыта',
  // Carousel translations
  com_carousel_title_creative_writing: 'Творческое письмо',
  com_carousel_title_problem_solving: 'Решение задач',
  com_carousel_title_fitness_coach: 'Фитнес тренер',
  com_carousel_title_code_assistant: 'Помощник программиста',
  com_carousel_story_request: 'Можешь помочь написать захватывающее начало истории?',
  com_carousel_story_response: 'Старый особняк возвышался перед ней, его выветренные окна словно пустые глаза смотрели в сумеречную мглу. Рука Сары дрожала, когда она потянулась к латунной дверной ручке, зная, что за этим порогом лежат ответы, которые она искала всю жизнь...',
  com_carousel_business_request: 'Мне нужна помощь в решении сложной бизнес-задачи по распределению ресурсов.',
  com_carousel_business_response: 'Давайте разберем это систематически. Сначала проанализируем текущее распределение ресурсов, затем определим узкие места и, наконец, разработаем стратегию оптимизации на основе данных...',
  com_carousel_fitness_request: 'Как оптимизировать тренировки и питание при плотном графике?',
  com_carousel_fitness_response: 'Вот ваш план, учитывая ваш график 50-часовой рабочей недели и цель набора мышечной массы: 3 интенсивные 30-минутные тренировки, фокус на составных упражнениях. Приемы пищи: 7:00 - протеиновый смузи, 10:00 - орехи/йогурт, 13:00 - курица с рисом, 16:00 - протеиновый батончик, 19:00 - рыба с овощами...',
  com_carousel_code_request: 'Я новичок в программировании и хочу создать простой сайт. С чего начать?',
  com_carousel_code_response: 'Давайте начнем с основ! Мы можем создать простой персональный сайт с помощью HTML и CSS. Я проведу вас через процесс создания красивой страницы с вашей биографией, интересами и даже блогом. Будем двигаться пошагово, никакой предварительный опыт не требуется!',
  // AIModelsInfo translations
  com_aibuddy_title: 'Центр управления искусственным интеллектом',
  com_aibuddy_why_choose: 'Почему мы?',
  com_aibuddy_why_choose_content: 'Преобразите свой опыт работы с ИИ благодаря единому рабочему пространству. Сравнивайте ответы разных моделей, используйте специализированные возможности и поддерживайте непрерывную историю диалогов между ассистентами.',
  com_aibuddy_power_choice: 'Умный выбор моделей',
  com_aibuddy_power_choice_content: 'Позвольте платформе подобрать идеальную модель для каждой задачи. Нужно написать текст? ChatGPT справится отлично. Работа с изображениями? Gemini - ваш выбор. Сложный анализ? Claude поможет. Мы упрощаем выбор, не требуя глубоких знаний об ИИ.',
  com_aibuddy_featured_models: 'Доступные модели ИИ',
  com_aibuddy_faq: 'Частые вопросы',
  
  // Model descriptions
  com_model_chatgpt_description: 'Специалист по естественному диалогу и творческим задачам. Превосходно справляется с написанием текстов, генерацией идей и объяснением сложных тем простым языком. Поддерживает контекстное общение в реальном времени.',
  com_model_gemini_description: 'Мультимодальная система от Google, способная одновременно работать с текстом, изображениями и данными. Идеально подходит для визуального анализа, оценки дизайна и решения задач, сочетающих разные типы информации.',
  com_model_claude_description: 'Эксперт в точности от Anthropic, обеспечивающий фактическую достоверность и глубину ответов. Отлично подходит для исследований, анализа документов и подробных, аргументированных объяснений.',
  com_model_deepseek_description: 'Ваш помощник в программировании, специализирующийся на разработке и технической документации. Предлагает продвинутое автодополнение кода, обнаружение ошибок и понятные технические объяснения.',
  
  // FAQ items
  com_faq_what_is: 'Чем AiBuddy отличается от прямого использования моделей ИИ?',
  com_faq_what_is_content: 'Представьте что это единый центр управления взаимодействием с ИИ - полноценное рабочее пространство, где можно сравнивать ответы, сохранять историю диалогов между моделями и легко переключаться между ассистентами. Получите доступ к нескольким моделям ИИ без необходимости управлять разными аккаунтами и интерфейсами.',
  com_faq_what_use: 'Какие есть примеры практического применения?',
  com_faq_what_use_content: 'Возможности безграничны: авторы контента могут сравнивать стили письма, разработчики - получать разные подходы к решению задач, исследователи - перепроверять анализ, а бизнес - подбирать идеальные модели под конкретные задачи. Более того, используйте несколько моделей в одном разговоре для всестороннего анализа.',
  com_faq_how_much: 'Как работает система оплаты?',
  com_faq_how_much_content: 'Наша гибкая система на основе токенов предлагает несколько уровней: начните с бесплатного плана для знакомства с базовыми функциями, перейдите на Профессиональный тариф для расширенных возможностей или выберите Pro+ решение для каждодневного интенсивного использования. Каждый уровень включает регулярно обновляемый запас токенов.',
  com_faq_what_tokens: 'Что такое токены и как они работают?',
  com_faq_what_tokens_content: 'Токены - это базовые единицы общения с ИИ, своего рода строительные блоки слов и символов. Каждое отправленное и полученное сообщение использует токены, причем длинные или сложные разговоры требуют больше токенов. Продвинутые модели вроде GPT-4 и Claude потребляют больше токенов, но обеспечивают более качественные ответы. Изображения требуют значительно больше токенов, чем текст, особенно при использовании продвинутых моделей компьютерного зрения. Ваша подписка включает запас токенов, который регулярно пополняется, причем тарифы более высокого уровня предоставляют доступ к более совершенным моделям.',
  com_ui_about_cta: 'Начать работу с ИИ',
};
