...
Используя Веб-сайт, вы подтверждаете, что прочитали настоящие Условия использования и соглашаетесь соблюдать их.`,
  ...
  com_aibuddy_title: 'AiBuddy - Ваш доступ к продвинутым возможностям ИИ',
  com_aibuddy_why_choose: 'В чем наше преимущество?',
  com_aibuddy_why_choose_content: 'AiBuddy предоставляет удобный доступ к ведущим ИИ-ассистентам, каждый из которых обладает уникальными возможностями. Наша платформа позволяет использовать ChatGPT, Google Gemini, DeepSeek, Claude и другие модели - всё в одном месте.',
  com_aibuddy_power_choice: 'Сила выбора',
  com_aibuddy_power_choice_content: 'Разные ассистенты сильны в разных задачах. Имея доступ к нескольким вариантам, вы всегда можете выбрать лучший инструмент для ваших конкретных нужд, будь то творческое письмо, программирование, анализ или решение проблем.',
  com_aibuddy_featured_models: 'Популярные ИИ-ассистенты',
  com_aibuddy_faq: 'Часто задаваемые вопросы',
  
  // Model descriptions
  com_model_chatgpt_description: 'Превосходен в естественном общении и творческих задачах. Идеален для создания контента и генерации идей.',
  com_model_gemini_description: 'Мощные мультимодальные возможности, отлично подходит для задач с текстом и изображениями.',
  com_model_claude_description: 'Известен своей точностью и детальным анализом. Идеален для исследований и решения сложных задач.',
  com_model_deepseek_description: 'Специализируется на технических задачах и программировании. Отличный выбор для разработчиков и технических проектов.',
  
  // FAQ items
  com_faq_what_is: 'Что такое AiBuddy и как это работает?',
  com_faq_what_is_content: 'AiBuddy - это единая платформа для доступа к различным ИИ-ассистентам. Мы предоставляем простой и интуитивно понятный интерфейс для взаимодействия с различными решениями мирового класса, каждое из которых обладает уникальными возможностями для достижения ваших целей.',
  com_faq_what_use: 'Для чего можно использовать AiBuddy?',
  com_faq_what_use_content: 'От написания текстов и программирования до анализа и творческих проектов, AiBuddy может помочь практически с любой задачей. Каждая модель имеет свои сильные стороны, позволяя выбрать идеального помощника для ваших конкретных нужд.',
  com_faq_how_much: 'Сколько это стоит?',
  com_faq_how_much_content: 'AiBuddy предлагает гибкие тарифные планы, включая бесплатный доступ к базовым функциям. Премиум планы открывают дополнительные возможности и увеличенные лимиты использования, подходящие как для индивидуальных пользователей, так и для команд.',
};
