...
Используя Веб-сайт, вы подтверждаете, что прочитали настоящие Условия использования и соглашаетесь соблюдать их.`,
  ...
  com_error_token_balance_note: 'Примечание: Ваш баланс автоматически пополняется каждые 12 часов до 500 токенов для бесплатного использования. Рассмотрите возможность подписки для непрерывного доступа ко всем функциям.',
