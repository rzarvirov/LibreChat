...
export default {
  ...
  com_subscription_view_plans: 'View Subscription Plans',
  com_subscription_title: 'Choose Your Plan',
  com_subscription_subtitle: 'Select the plan that best fits your needs',
  com_subscription_button: 'Subscribe',
  com_subscription_manage: 'Manage Subscription',
  com_subscription_cancel: 'Cancel Subscription',
  com_subscription_current_plan: 'Current Plan',
  com_subscription_balance: 'Balance',
  com_subscription_next_payment: 'Next Payment',
  com_subscription_cancel_confirm: 'Are you sure you want to cancel your subscription?',
  com_subscription_cancel_success: 'Your subscription will be canceled at the end of the billing period',
  com_subscription_no_active: 'No active subscription found',
  com_subscription_change_plan: 'Change Plan',
  com_subscription_status: 'Status',
  com_subscription_basic: 'Basic',
  com_subscription_pro: 'Pro',
  com_subscription_proplus: 'Pro+',
  com_subscription_subscribe: 'Subscribe Now',
  com_subscription_basic_price: '$1.99/mo',
  com_subscription_pro_price: '$4.99/mo',
  com_subscription_proplus_price: '$9.99/mo',
  com_subscription_basic_feature_1: 'Access to Basic AI Assistants',
  com_subscription_basic_feature_2: 'Up to ~100 messages/day',
  com_subscription_basic_feature_3: 'ChatGPT, Claude, Google, and more',
  com_subscription_pro_feature_1: 'Access to Professional AI Assistants',
  com_subscription_pro_feature_2: 'Up to ~500 messages/day',
  com_subscription_pro_feature_3: 'Build Custom Agents',
  com_subscription_pro_feature_4: 'ChatGPT o1, Claude Sonnet, DeepSeek R1, and more',
  com_subscription_proplus_feature_1: 'All Pro features',
  com_subscription_proplus_feature_2: 'No daily message limit',
  com_subscription_proplus_feature_3: 'Premium support',
  com_subscription_proplus_feature_4: 'Early access to new features',
  com_subscription_proplus_feature_5: 'Top speed and performance',
  com_subscription_token_credits: '{0} token credits',
  com_subscription_basic_tokens: '350,000',
  com_subscription_pro_tokens: '1,000,000',
  com_subscription_proplus_tokens: '3,000,000',
  com_subscription_canceling: 'Subscription Canceling',
  com_subscription_active_until: 'Your {0} plan will remain active until {1}. After this date, your account will revert to a FREE plan.',
  com_subscription_keep: 'Keep my subscription',
  com_subscription_reactivated: 'Your subscription has been reactivated successfully',
  com_subscription_login_required: 'Please log in to manage your subscription',
  com_subscription_login_change: 'Please log in to change your subscription',
  com_subscription_error_cancel: 'Failed to cancel subscription',
  com_subscription_error_reactivate: 'Failed to reactivate subscription',
  com_subscription_error_change: 'Failed to change subscription',
  com_error_insufficient_funds: 'Insufficient Funds! Balance: {{0}}',
  com_token_what_are_tokens: 'What are AI Tokens?',
  com_token_explanation_brain: 'Tokens are units of text processing. One token can be a common word, part of a word, or even a single letter. More advanced AI breaks text into smaller tokens for better understanding.',
  com_token_explanation_chat: 'Both your input and AIs output use tokens. Simple formula: Longer conversations + Smarter AI = More tokens used.',
  com_token_explanation_image: 'Images require significantly more tokens than text because they contain more data points to process',
  com_subscription_cancel_notice: 'You can cancel your subscription at any time from Account Settings.',
  // Error messages
  com_error_ban: 'Your account has been temporarily banned due to violations of our service.',
  com_error_invalid_api_key: 'Invalid API key. Please check your API key and try again. You can do this by clicking on the model logo in the left corner of the textbox and selecting "Set Token" for the current selected endpoint. Thank you for your understanding.',
  com_error_insufficient_quota: 'We apologize for any inconvenience caused. The default API key has reached its limit. To continue using this service, please set up your own API key. You can do this by clicking on the model logo in the left corner of the textbox and selecting "Set Token" for the current selected endpoint. Thank you for your understanding.',
  com_error_concurrent: 'Only {0} message{1} at a time. Please allow any other responses to complete before sending another message, or wait one minute.',
  com_error_message_limit: 'You hit the message limit. You have a cap of {0} message{1} per {2}.',
  com_error_token_balance: 'Your current balance is {0} tokens.',
  com_error_token_balance_note: 'Note: Your balance automatically renews every 12 hours up to 500 tokens for free usage. Consider subscribing for uninterrupted access to all features.',
  com_error_default: 'Something went wrong. Your request is not supported by the selected model',
  com_model_features_speed: 'Speed',
  com_model_features_speed_fast: 'Fast',
  com_model_features_speed_medium: 'Medium',
  com_model_features_speed_slow: 'Slow',
  com_model_features_image_support: 'Image Support',
  com_model_features_document_support: 'Document Support',
  com_model_features_intelligence: 'Intelligence',
  com_model_features_intelligence_basic: 'Basic',
  com_model_features_intelligence_medium: 'Medium',
  com_model_features_intelligence_high: 'High',
  com_model_features_intelligence_very_high: 'Very High',
  com_model_features_context_window: 'Context Window',
  com_model_features_context_window_suffix: 'tokens',
  com_ui_typewriter_help_me: 'Help me 🌞 to ',
  com_ui_typewriter_write_text: 'write text',
  com_ui_typewriter_analyze_images: 'analyze images',
  ...
  com_aibuddy_title: 'Your AI Collaboration Hub',
  com_aibuddy_why_choose: 'Why Choose Us?',
  com_aibuddy_why_choose_content: 'Transform your AI experience with a unified workspace for all your interactions. Compare responses across different models, leverage specialized capabilities, and maintain seamless conversation history across multiple assistants.',
  com_aibuddy_power_choice: 'Intelligent Model Selection',
  com_aibuddy_power_choice_content: 'Let our platform guide you to the perfect AI for each task. Whether you need creative writing with ChatGPT, visual analysis with Gemini, or complex research with Claude, we help you make informed choices without requiring AI expertise.',
  com_aibuddy_featured_models: 'Featured AI Models',
  com_aibuddy_faq: 'Common Questions',
  
  // Model descriptions
  com_model_chatgpt_description: 'Natural dialogue specialist optimized for creative tasks. Excels at writing, brainstorming, and explaining complex topics in simple terms. Features real-time conversation and context awareness.',
  com_model_gemini_description: 'Google\'s multimodal powerhouse that seamlessly handles text, images, and data. Ideal for visual analysis, design feedback, and solving problems that combine different types of information.',
  com_model_claude_description: 'Anthropic\'s precision expert, delivering factual accuracy and nuanced responses. Perfect for research, document analysis, and detailed, well-reasoned explanations.',
  com_model_deepseek_description: 'Your coding companion, specializing in software development and technical documentation. Offers advanced code completion, bug detection, and clear technical explanations.',
  
  // FAQ items
  com_faq_what_is: 'How is this different from using AI models directly?',
  com_faq_what_is_content: 'Think of this as your command center for AI interactions - a complete workspace where you can compare responses, maintain conversation history across models, and seamlessly switch between assistants. Access multiple AI models without juggling different accounts and interfaces.',
  com_faq_what_use: 'What are some real-world applications?',
  com_faq_what_use_content: 'The possibilities are endless: Content creators can compare writing styles, developers can gather multiple perspectives on code solutions, researchers can cross-reference analyses, and businesses can match specific tasks to ideal models - all in one interface. Plus, use multiple models in the same conversation for comprehensive insights.',
  com_faq_what_tokens: 'What are tokens and how do they work?',
  com_faq_what_tokens_content: 'Tokens are the building blocks of AI communication - think of them as pieces of words or symbols. Each message you send and receive uses tokens, with longer or more complex conversations using more tokens. More advanced models like GPT-4 and Claude consume more tokens but provide higher quality responses. Images require significantly more tokens than text, especially with advanced vision models. Your subscription includes a token allowance that refreshes regularly, with higher tiers offering access to more sophisticated models.',
