...
export default {
  ...
  com_error_token_balance_note: 'Note: Your balance automatically renews every 12 hours up to 1000 tokens for free usage. Consider subscribing for uninterrupted access to all features.',
